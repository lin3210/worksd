...
/**
 * @ClassName: QryBatchStatusService
 * @Description: 出金批次状态查询
 * @author jack-cooper
 * @date 2015-6-12 下午1:37:04
 */
public class DsfNewService extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String url = DsfConfig.payquerynew;
