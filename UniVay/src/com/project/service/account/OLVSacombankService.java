...
public class OLVSacombankService extends BaseService {
	...
	public String getUserBankusername(int userid){
		String sql = "select napasusername from sd_bankcard where userid='"+userid+"'";
		return getJdbcTemplate().queryString(sql);
	}
	public int getAllFKcount(int userid,String timeday){
	...
	public void updateHK(DataRow row)
	{
	 ...
	 public Integer getJK(int  jkid)
      ...
      public Integer getUserID(String  userid)
    		{
    			String sql = "select id from sd_new_jkyx where userid= '" +userid+"'and sfyfk=2 and sfyhw=0 limit 1 " ;
